  ...
  return (
    ...
    >
      <Presence
        present={present}
        className={twMerge([
          'relative w-full px-10 pt-8 pb-6.5 [&>svg]:drop-shadow-[0_0px_20px_var(--color-primary)]',
...
function AlertTitle({
  ...
  return (
    <div
      className={twMerge([
        'text-shadow-primary relative flex w-full items-center font-bold text-shadow-lg',
        className,
      ])}
      {...props}
    >
...
function AlertCloseTrigger({
  ...
  return (
    <Button
      ...
      variant="accent"
      className={twMerge([
        'absolute top-2 -right-1 scale-x-[-1] transform px-5 py-1.5',
